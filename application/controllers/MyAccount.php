                ...
                case 'register':
                    ...
                    if ($usercount==0){
                        ...
                        if ($this->form_validation->run() == TRUE){
                          ...
                          $mail->Username = 'jakeserrano201@gmail.com';                 // SMTP username
                          $mail->Password = 'alohamora20';                           // SMTP password
                          ...
                          $mail->Body    = '<html>
                           <head>
                            ...
                            <body>
                                <center><h4>Welcome to Furnies OL-Shoppe</h4>
                          ...
                          // $mail->Body    = "<div id='button'>Thank you for registering to Furnies OL-Shoppe, Please wait for the admin to approve your account, Thank you. </div>";
                          ...
                          $response['stat']='success';
                          $response['msg'] = 'An email is sent to your email address. Please click the Button to verify your account.';
                        }
                        else{
                          $response['stat'] = 'error';
